...
$candidatos = [
    dirname($_SERVER['DOCUMENT_ROOT']) . '/bruto-secrets/API/salvar-ordem.php',
    dirname(dirname($_SERVER['DOCUMENT_ROOT'])) . '/bruto-secrets/API/salvar-ordem.php',
    ...
    '/home/u764636502/domains/brutoceramica.com.br/bruto-secrets/API/salvar-ordem.php',
];
...
echo json_encode(['erro' => 'Não encontrei o backend em bruto-secrets/API/salvar-ordem.php — confira se o arquivo existe e se a pasta do subdomínio está correta.']);
