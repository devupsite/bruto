...
echo json_encode(['erro' => 'Não encontrei o backend em bruto-secrets/API/whatsapp-fornecedor.php — confira se o arquivo existe e se a pasta do subdomínio está correta.']);
