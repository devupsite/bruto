...
$candidatos = [
    dirname($_SERVER['DOCUMENT_ROOT']) . '/bruto-secrets/API/atualizar-status.php',
    dirname(dirname($_SERVER['DOCUMENT_ROOT'])) . '/bruto-secrets/API/atualizar-status.php',
    ...
    '/home/u764636502/domains/brutoceramica.com.br/bruto-secrets/API/atualizar-status.php',
];
...
echo json_encode(['erro' => 'Não encontrei o backend em bruto-secrets/API/atualizar-status.php — confira se o arquivo existe e se a pasta do subdomínio está correta.']);
