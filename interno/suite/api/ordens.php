...
$candidatos = [
    dirname($_SERVER['DOCUMENT_ROOT']) . '/bruto-secrets/API/suite-ordens.php',
    dirname(dirname($_SERVER['DOCUMENT_ROOT'])) . '/bruto-secrets/API/suite-ordens.php',
];
...
echo json_encode(['erro' => 'Não encontrei o backend em bruto-secrets/API/suite-ordens.php — confira se o arquivo existe e se a pasta do subdomínio está correta.']);
